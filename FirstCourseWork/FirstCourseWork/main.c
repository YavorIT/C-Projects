...
// The program counts the number of the comments in a given C code
// Sorry for the cyrillic this was a part of the task!

// Simply you choose an option: 
// 1. File to file
// 2. File to the console
// 3. Console to file
// 4. Console to console

// then enter the file name or directly the code. Depends on your first choice!
